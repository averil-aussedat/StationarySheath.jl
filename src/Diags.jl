...
"""
function build_fe!(fe::Matrix, params::Params, f_eb::Feb, phix::Vector{Float64}, lowerbound::Float64)
    meshve = collect(LinRange(lowerbound, 0.0, params.Nve+1))
...
"""
function build_fi!(fi::Matrix, params::Params, f_eb::Feb, phix::Vector{Float64}, phidx::Vector{Float64}, lowerbound::Float64)
    meshvi = collect(LinRange(lowerbound, 0.0, params.Nvi+1))
...
function diags_loop(params::Params, phi::Phidata, ni::Vector{Float64}, ne::Vector{Float64}, 
    phix::Vector{Float64}, phixp::Vector{Float64}, n::Int, eps::Float64; verbose::Bool=false)
...
function diags_end(params::Params, phi::Phidata, f_eb::Feb, ni::Vector{Float64}, ne::Vector{Float64}, 
    ...
    png(heatmap(params.meshx.mesh,LinRange(lowerbound,0.0,params.Nve+1),fe), "data/fe.png")
    png(heatmap(params.meshx.mesh,LinRange(lowerbound,0.0,params.Nvi+1),fi), "data/fi.png")
